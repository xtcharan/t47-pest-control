...
export const searchData: SearchItem[] = [
  ...
  {
    id: 'about',
    title: 'About T47 Pest Control',
    description: 'Learn about our professional pest control company, our team, and our commitment to excellent service.',
    keywords: ['about us', 'pest control company', 'pest control team', 'pest control history', 'pest control mission'],
    url: '/about',
    category: 'general',
    image: '/about.svg'
  },
