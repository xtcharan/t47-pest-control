...
export default function PossumControlBanner() {
  return (
    <section className="bg-[linear-gradient(135deg,_#9C27B0_50%,_#7B1FA2_50%)] pt-6 pb-10 relative overflow-hidden z-20 -mt-2">
      ...
      <div className="container mx-auto px-4 relative z-30">
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          <p className="text-xl md:text-2xl text-white max-w-4xl mx-auto text-center font-light">
            Safe, effective removal and prevention strategies that respect wildlife
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6 lg:gap-8 mb-2">
          <div className="flex flex-col items-center text-center px-3 py-2 w-32">
            ...
            <div className="h-10 flex items-center justify-center">
              <span className="text-white font-semibold text-base">Property<br />Inspection</span>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center px-3 py-2 w-32">
            ...
            <div className="h-10 flex items-center justify-center">
              <span className="text-white font-semibold text-base">Humane<br />Trapping</span>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center px-3 py-2 w-32">
            ...
            <div className="h-10 flex items-center justify-center">
              <span className="text-white font-semibold text-base">Safe<br />Relocation</span>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center px-3 py-2 w-32">
            ...
            <div className="h-10 flex items-center justify-center">
              <span className="text-white font-semibold text-base">Wildlife<br />Friendly</span>
            </div>
          </div>
