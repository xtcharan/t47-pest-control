...
export default function ElderlyCarePestControlBanner() {
  return (
    <section className="bg-[linear-gradient(135deg,_#009688_50%,_#00897B_50%)] pt-6 pb-10 relative overflow-hidden z-20 -mt-2">
      {/* Diagonal pattern background */}
      <div className={`absolute inset-0 z-10 opacity-15 ${styles.patternBackground}`}
      ></div>

      {/* Diagonal overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#004D40]/10 to-transparent z-20"></div>
      ...
      <div className="container mx-auto px-4 relative z-30">
        ...
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          <p className="text-xl md:text-2xl text-white max-w-4xl mx-auto text-center font-light">
            Protecting resident health and facility compliance with specialized pest management solutions
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6 lg:gap-8 mb-2">
          ...
          <div className="flex flex-col items-center text-center px-3 py-2 w-32">
            ...
            <div className="h-10 flex items-center justify-center">
              <span className="text-white font-semibold text-base">Resident<br />Safety</span>
            </div>
          </div>
