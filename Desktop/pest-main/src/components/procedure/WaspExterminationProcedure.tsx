...
export default function WaspExterminationProcedure() {
  ...
  const procedureSteps = [
    {
      ...
      title: "Wasp Nest Inspection",
      description: "Our professional technicians begin by conducting a thorough inspection of your property to locate all wasp nests. We identify the wasp species, assess the size and activity level of the colony, and determine the safest removal approach based on the nest location and surrounding environment."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Based on our inspection findings, we develop a customized treatment plan for safe and effective wasp nest removal. Our plans consider factors such as nest accessibility, proximity to living areas, and the presence of children or pets. We'll explain the process and any safety precautions needed during treatment."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: "Nest Removal",
      description: "Our technicians use specialized equipment and professional-grade products to safely eliminate the wasp colony and remove the nest. We employ targeted treatments that minimize risks to humans, pets, and beneficial insects. For hard-to-reach nests, we may use extension poles or other specialized tools to ensure complete removal."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "After successful nest removal, we implement preventative measures to discourage future wasp activity. This includes sealing entry points, removing attractants, and applying deterrent treatments to areas where wasps commonly build nests. We also provide recommendations for ongoing prevention to keep your property wasp-free."
    }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl font-bold mb-4 text-gray-900">
            Our Wasp <span className="text-blue-600">Extermination</span> Procedure
          </h2>
          <div className="w-24 h-1 bg-blue-600 mx-auto mb-6"></div>
          <p className="text-gray-600 max-w-3xl mx-auto">
            Wasp nests can pose serious health risks, especially for those with allergies. Our comprehensive
            approach ensures safe, effective removal of wasp nests and long-term protection for your property.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <div className="bg-blue-600 text-white p-6 rounded-xl shadow-lg max-w-2xl mx-auto transform hover:scale-[1.02] transition-transform duration-300 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-xl font-semibold mb-3">Need safe wasp nest removal?</h3>
              <p className="text-white/80 mb-4">Our professional wasp control team is ready to safely remove wasp nests from your property.</p>
