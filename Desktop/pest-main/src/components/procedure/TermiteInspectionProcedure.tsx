  ...
  const procedureSteps = [
    {
      ...
      description: "We begin with a detailed discussion about your property, any concerns you have, and your inspection history. This helps us understand your specific needs and tailor our inspection approach. We'll explain what to expect during the inspection and answer any questions you might have about the process."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Our inspector conducts a thorough examination of your property's exterior, including the perimeter, foundation, roof eaves, and garden areas. We look for mud tubes, damaged wood, and conditions that attract termites such as wood-to-soil contact, improper drainage, and excessive moisture. We use moisture meters to identify areas of concern that may not be visible to the naked eye."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "We inspect all accessible interior areas of your home, including the kitchen, bathrooms, living areas, and bedrooms. We pay special attention to areas prone to moisture issues and check for signs of termite activity such as hollow-sounding timber, bubbling paint, and sagging floors or ceilings. We use thermal imaging cameras to detect temperature variations that might indicate termite activity behind walls."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "If accessible, we inspect your roof void (attic) and subfloor areas, which are common entry points for termites. We check all timber structures, including roof trusses, floor joists, and bearers for signs of termite activity or damage. We also look for adequate ventilation and identify any moisture issues that could attract termites. These areas often reveal termite problems before they become visible in living areas."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: "Advanced Technology Assessment",
      description: "We employ specialized equipment including thermal imaging cameras to detect heat signatures of termite activity, moisture meters to identify areas of excess moisture that attract termites, and acoustic detection devices to listen for termite activity within timber structures. These technologies allow us to detect termite presence that would be missed in a visual-only inspection, providing a more accurate assessment of your property's termite status."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Following the inspection, we provide a comprehensive report documenting our findings, including any termite activity, damage, or conducive conditions. The report includes photographs, detailed explanations, and specific recommendations for treatment if termites are found or preventative measures if no current activity is detected. We'll walk you through the report, answer your questions, and discuss the most appropriate termite management options for your property."
    }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl font-bold mb-4 text-gray-900">
            Our Termite <span className="text-blue-600">Inspection</span> Process
          </h2>
          <div className="w-24 h-1 bg-blue-600 mx-auto mb-6"></div>
          <p className="text-gray-600 max-w-3xl mx-auto">
            Our thorough six-step inspection process combines visual examination with advanced technology to detect termite activity, even in hidden areas of your property.
          </p>
        </div>
