...
export default function SilverfishControlProcedure() {
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl font-bold mb-4 text-gray-900">
            Our Silverfish <span className="text-blue-600">Elimination</span> Process
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="relative rounded-xl overflow-hidden shadow-xl h-[400px] md:h-[500px] group">
            ...
            <div className="absolute inset-0.5 rounded-xl overflow-hidden z-20">
              ...
              <Image
                src="/silverfish-control-process.jpg"
                alt="Professional Silverfish Control Process"
                fill
        ...
        <div className="mt-12 text-center">
          <div className="bg-blue-600 text-white p-6 rounded-xl shadow-lg max-w-2xl mx-auto transform hover:scale-[1.02] transition-transform duration-300 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-xl font-semibold mb-3">Ready to eliminate your silverfish problem?</h3>
              <p className="text-white/80 mb-4">Our silverfish control specialists are ready to protect your home and valuable belongings from these destructive pests.</p>
