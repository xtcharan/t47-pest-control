  ...
  return (
    <div className="relative min-h-[600px] md:min-h-[650px] bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="absolute inset-0 z-[1] pointer-events-none">
        ...
        <div className="absolute top-1/3 right-1/4 w-3 h-3 rounded-full bg-red-400/40 animate-pulse-slow delay-300"></div>
      ...
      <div className="container mx-auto px-4 py-16 md:py-20 relative z-10 flex flex-col md:flex-row items-center">
        ...
        >
          <div className="mb-6 inline-block">
            <span className="inline-block px-4 py-1 bg-red-500/90 text-white text-sm font-bold rounded-full mb-4 animate-float">
              PROFESSIONAL PEST CONTROL SERVICES
            </span>
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            <span className="text-red-400 block mb-2">PEST DONT SLEEP</span>
          ...
          <div className="flex flex-wrap gap-4 mt-2">
            <button type="button" className="modern-button bg-red-500 hover:bg-red-600 text-white transition-colors">
              Our Services
            </button>
