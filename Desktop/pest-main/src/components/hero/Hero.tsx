      ...
      <div className="md:hidden flex flex-col">
        ...
        <div className={`w-full bg-[#0a0a0a] px-6 py-10 -mt-10 rounded-t-3xl shadow-lg transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="flex justify-center gap-4 mt-2 mb-12">
            <button type="button" className="modern-button bg-green-light hover:bg-green-dark text-black transition-colors shadow-md">
              Our Services
            </button>
            <button type="button" className="modern-button bg-transparent border-2 border-white hover:bg-white/10 text-white transition-colors shadow-md">
              Contact Us
            </button>
          </div>
