...
export default function BedBugLifecycleGallery() {
  const bedBugStages: BedBugStageProps[] = [
    ...
    },
    {
      ...
      description: "Second instar nymphs grow to about 2mm and develop a darker yellowish-brown coloration after feeding. They become more active in seeking hosts and hiding places. This stage represents the intermediate development phase before reaching adulthood, requiring multiple blood meals to continue growth."
    },
    {
      name: "Adult Bed Bug",
