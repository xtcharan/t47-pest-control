  ...
  const renderIndustries = () => {
    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        {!showAllIndustries ? (
          <div
            className="bg-gray-800 p-4 rounded-md shadow-sm flex flex-col items-center justify-center text-center cursor-pointer hover:bg-gray-900 transition-colors h-44 w-full"
