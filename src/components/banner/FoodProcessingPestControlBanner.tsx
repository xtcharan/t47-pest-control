...
export default function FoodProcessingPestControlBanner() {
  return (
    <section className="bg-[linear-gradient(135deg,_#4CAF50_50%,_#388E3C_50%)] pt-6 pb-10 relative overflow-hidden z-20 -mt-2">
      {/* Diagonal pattern background */}
      <div className={`absolute inset-0 z-10 opacity-15 ${styles.patternBackground}`}
      ></div>

      {/* Diagonal overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#1B5E20]/10 to-transparent z-20"></div>
      ...
      <div className="container mx-auto px-4 relative z-30">
        ...
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          <p className="text-xl md:text-2xl text-white max-w-4xl mx-auto text-center font-light">
            Protecting product integrity and food safety with specialized pest management solutions
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6 lg:gap-8 mb-2">
          ...
          <div className="flex flex-col items-center text-center px-3 py-2 w-32">
            ...
            <div className="h-10 flex items-center justify-center">
              <span className="text-white font-semibold text-base">HACCP<br />Compliance</span>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center px-3 py-2 w-32">
            ...
            <div className="h-10 flex items-center justify-center">
              <span className="text-white font-semibold text-base">Food<br />Safety</span>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center px-3 py-2 w-32">
            ...
            <div className="h-10 flex items-center justify-center">
              <span className="text-white font-semibold text-base">Audit<br />Support</span>
            </div>
          </div>
