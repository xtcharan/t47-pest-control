...
export default function HotelPestControlBanner() {
  return (
    <section className="bg-[linear-gradient(135deg,_#FFA000_50%,_#FF8F00_50%)] pt-6 pb-10 relative overflow-hidden z-20 -mt-2">
      ...
      <div className="container mx-auto px-4 relative z-30">
        ...
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          <p className="text-xl md:text-2xl text-white max-w-4xl mx-auto text-center font-light">
            Protecting guest experience and your reputation with specialized pest management solutions
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6 lg:gap-8 mb-2">
          ...
          <div className="flex flex-col items-center text-center px-3 py-2 w-32">
            ...
            <div className="h-10 flex items-center justify-center">
              <span className="text-white font-semibold text-base">Guest<br />Experience</span>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center px-3 py-2 w-32">
            ...
            <div className="h-10 flex items-center justify-center">
              <span className="text-white font-semibold text-base">Bed Bug<br />Specialists</span>
            </div>
          </div>
