        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div>
            ...
            <ul className={`space-y-2 ${openSection === 'quickLinks' || !isMobile ? 'block' : 'hidden md:block'}`}>
              ...
              <li><Link href="/local-branches" className="text-gray-400 hover:text-white transition-colors">Local Branches</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className={`grid grid-cols-2 gap-x-2 gap-y-1 ${openSection === 'locations' || !isMobile ? 'block' : 'hidden md:block'}`}>
              <Link href="/local-branches/melbourne" className="text-gray-400 hover:text-white transition-colors">Melbourne</Link>
              <Link href="/local-branches/sydney" className="text-gray-400 hover:text-white transition-colors">Sydney</Link>
              <Link href="/local-branches/brisbane" className="text-gray-400 hover:text-white transition-colors">Brisbane</Link>
              <Link href="/local-branches/perth" className="text-gray-400 hover:text-white transition-colors">Perth</Link>
              <Link href="/local-branches/adelaide" className="text-gray-400 hover:text-white transition-colors">Adelaide</Link>
              <Link href="/local-branches/canberra" className="text-gray-400 hover:text-white transition-colors">Canberra</Link>
              <Link href="/local-branches/darwin" className="text-gray-400 hover:text-white transition-colors">Darwin</Link>
              <Link href="/local-branches/hobart" className="text-gray-400 hover:text-white transition-colors">Hobart</Link>
            </div>
          </div>
