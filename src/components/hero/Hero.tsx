        ...
        <div className="container mx-auto px-4 py-16 md:py-20 relative z-10 flex flex-row items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 mt-2">
              <Link
                href="#service-categories"
                className="modern-button bg-green-light hover:bg-green-dark text-black transition-colors inline-flex items-center justify-center"
              >
                Our Services
              </Link>
              <Link
                href="/contact"
                className="modern-button bg-transparent border-2 border-white hover:bg-white/10 text-white transition-colors inline-flex items-center justify-center"
              >
                Contact Us
              </Link>
            </div>
