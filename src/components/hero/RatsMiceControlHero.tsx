    ...
    <div className="relative min-h-[600px] md:min-h-[650px] bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="md:hidden flex flex-col">
        ...
        <div className="relative h-[480px] w-full overflow-hidden">
          ...
          <div className="absolute top-6 left-0 right-0 flex justify-center">
            <span className="px-5 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white text-sm font-bold rounded-full shadow-lg animate-float">
              RAT & MOUSE CONTROL SERVICES
            </span>
          </div>

          {/* Small decorative elements */}
          <div className="absolute bottom-16 left-6 w-2 h-2 rounded-full bg-red-400/70 animate-pulse-slow"></div>
          <div className="absolute bottom-24 right-8 w-3 h-3 rounded-full bg-red-500/60 animate-pulse-slow delay-300"></div>
        </div>
        ...
        <div className={`w-full bg-[#0a0a0a] px-6 py-10 -mt-10 rounded-t-3xl shadow-lg transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h1 className="text-3xl sm:text-4xl font-bold mb-5 leading-tight text-center text-white">
            Complete Rat & Mouse <span className="text-gradient-red font-extrabold">Elimination</span> Services
          </h1>

          <div className="w-24 h-1 bg-gradient-to-r from-red-500 to-red-600 mb-6 mx-auto"></div>

          {/* Mobile-specific service badge */}
          <div className="flex justify-center mb-6">
            <span className="inline-block px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white text-sm font-bold rounded-full">
              RAT & MOUSE CONTROL SERVICES
            </span>
          </div>

          <p className="text-lg mb-6 text-white text-center max-w-md mx-auto">
          ...
          <ul className="mb-8 space-y-3 max-w-md mx-auto">
            ...
            <li className="flex items-center">
              ...
              <span className="text-white">7-day availability including public holidays</span>
            </li>
            <li className="flex items-center">
              <span className="inline-flex items-center justify-center w-6 h-6 mr-2 bg-gradient-to-r from-red-500 to-red-600 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
              ...
              <span className="text-white">Eco-friendly methods</span>
            </li>
            <li className="flex items-center">
              <span className="inline-flex items-center justify-center w-6 h-6 mr-2 bg-gradient-to-r from-red-500 to-red-600 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" viewBox="0 0 20 20" fill="currentColor">
              ...
              <span className="text-white">Free follow-up appointments</span>
            </li>
          </ul>

          <div className="flex justify-center gap-4 mt-2 mb-12">
            <Link href="/contact" className="modern-button bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white transition-colors shadow-md">
              Book Treatment
            </Link>
          ...
          <div className="w-full max-w-md mx-auto bg-[#111] p-6 rounded-xl shadow-lg border border-red-500/20">
      ...
      <div className="hidden md:block">
        ...
        <div className="absolute inset-0 z-[1] pointer-events-none">
          <div className="absolute top-1/4 left-1/5 w-2 h-2 rounded-full bg-red-400/50 animate-pulse-slow"></div>
          <div className="absolute top-1/3 right-1/4 w-3 h-3 rounded-full bg-red-500/40 animate-pulse-slow delay-300"></div>
          <div className="absolute bottom-1/4 left-1/3 w-2 h-2 rounded-full bg-red-600/50 animate-pulse-slow delay-700"></div>
        </div>
        ...
        <div className="container mx-auto px-4 py-16 md:py-20 relative z-10 flex flex-row items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">
              Complete Rat & Mouse <span className="text-gradient-red">Elimination</span> Services
            </h1>
