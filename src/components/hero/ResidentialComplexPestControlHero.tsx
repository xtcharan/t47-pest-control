...
export default function ResidentialComplexPestControlHero() {
    ...
    <div className="relative min-h-[600px] md:min-h-[650px] bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="md:hidden flex flex-col">
        ...
        <div className="relative h-[480px] w-full overflow-hidden">
          <OptimizedImage
            src="/residential-complex-pest-control-hero.webp"
            fallbackSrc="/residential-complex-pest-control-hero.jpg"
            alt="Residential Complex Pest Control Services"
            fill
            priority
            sizes="100vw"
        ...
        <div className={`w-full bg-[#0a0a0a] px-6 py-10 -mt-10 rounded-t-3xl shadow-lg transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h1 className="text-3xl sm:text-4xl font-bold mb-5 leading-tight text-center">
            <span className="text-purple-400 block mb-2">MULTI-UNIT</span>
            <span className="text-white block">RESIDENTIAL PEST CONTROL</span>
          </h1>

          <div className="w-24 h-1 bg-purple-500 mb-6 mx-auto"></div>

          <p className="text-lg mb-8 text-white text-center max-w-md mx-auto">
            Specialized pest management solutions for apartment buildings and residential complexes that protect tenant satisfaction and property value.
          </p>

          <div className="flex justify-center gap-4 mt-2 mb-12">
            <Link href="/contact" className="modern-button bg-purple-600 hover:bg-purple-700 text-white transition-colors shadow-md">
              Book Inspection
            </Link>
      ...
      <div className="hidden md:block">
        ...
        <div className="absolute inset-0 z-[1] pointer-events-none">
          ...
          <div className="absolute top-1/3 right-1/4 w-3 h-3 rounded-full bg-purple-500/40 animate-pulse-slow delay-300"></div>
          <div className="absolute bottom-1/4 left-1/3 w-2 h-2 rounded-full bg-purple-600/50 animate-pulse-slow delay-700"></div>
        </div>
        ...
        <div className="container mx-auto px-4 py-16 md:py-20 relative z-10 flex flex-row items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 mt-2">
              <Link href="/contact" className="modern-button bg-purple-600 hover:bg-purple-700 text-white transition-colors">
                Book Inspection
              </Link>
