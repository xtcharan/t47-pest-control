...
export default function FlyControlHero() {
    ...
    <div className="relative min-h-[600px] md:min-h-[650px] bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="md:hidden flex flex-col">
        ...
        <div className="relative h-[480px] w-full overflow-hidden">
          <OptimizedImage
            src="/fly-control-hero.webp"
            fallbackSrc="/fly-control-hero.jpg"
            alt="Professional Fly Control and Prevention Services"
            fill
            priority
            sizes="100vw"
          ...
          <div className="absolute top-6 left-0 right-0 flex justify-center">
            <span className="px-5 py-2 bg-amber-500/95 text-black text-sm font-bold rounded-full shadow-lg animate-float">
        ...
        <div className={`w-full bg-[#0a0a0a] px-6 py-10 -mt-10 rounded-t-3xl shadow-lg transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h1 className="text-3xl sm:text-4xl font-bold mb-5 leading-tight text-center">
            ...
            <span className="text-white block">FLY CONTROL</span>
          </h1>

          <div className="w-24 h-1 bg-amber-500 mb-6 mx-auto"></div>

          <p className="text-lg mb-8 text-white text-center max-w-md mx-auto">
            Comprehensive solutions to eliminate fly infestations and protect your home, business, and health from these disease-carrying pests.
          </p>

          <div className="flex justify-center gap-4 mt-2 mb-12">
            <Link href="/contact" className="modern-button bg-amber-500 hover:bg-amber-600 text-black transition-colors shadow-md">
              Schedule Inspection
            </Link>
      ...
      <div className="hidden md:block">
        ...
        <div className="absolute inset-0 z-[1] pointer-events-none">
          ...
          <div className="absolute bottom-1/4 left-1/3 w-2 h-2 rounded-full bg-amber-500/50 animate-pulse-slow delay-700"></div>
        </div>
        ...
        <div className="container mx-auto px-4 py-16 md:py-20 relative z-10 flex flex-row items-center">
          ...
          >
            <div className="mb-6 inline-block">
              <span className="inline-block px-4 py-1 bg-amber-500/90 text-black text-sm font-bold rounded-full mb-4 animate-float">
                EFFECTIVE FLY MANAGEMENT
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-4 mt-2">
              <Link href="/contact" className="modern-button bg-blue-500 hover:bg-blue-600 text-white transition-colors">
                Schedule Inspection
              </Link>
