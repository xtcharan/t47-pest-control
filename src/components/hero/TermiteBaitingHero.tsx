        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center w-full pt-16 pb-8">
          ...
          <div className={`text-white space-y-6 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="space-y-4">
              <span className="inline-block px-4 py-2 bg-purple-600/20 backdrop-blur-sm border border-purple-400/30 text-purple-300 text-sm font-semibold rounded-full">
                🎯 STRATEGIC BAITING SYSTEMS
              </span>

              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                Termite Baiting Systems
                <span className="block text-purple-400">in Melbourne</span>
              ...
              <p className="text-lg md:text-xl text-gray-300 max-w-xl leading-relaxed">
                ...
                Predictable pathway to control with clear, staged visual evidence.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
              {[
                ...
                <div key={index} className="flex items-center space-x-3 group">
                  <div className="flex-shrink-0 w-8 h-8 bg-purple-600/20 backdrop-blur-sm border border-purple-400/30 rounded-full flex items-center justify-center group-hover:bg-purple-600/30 transition-colors duration-300">
                    {feature.icon}
                  </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <Link
                href="/contact"
                className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-4 px-8 rounded-full transition-all duration-300 text-center shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                Get Free Assessment
              </Link>
              <Link
