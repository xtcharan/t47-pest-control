...
export default function BirdControlHero() {
    ...
    <div className="relative min-h-[600px] md:min-h-[650px] bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="md:hidden flex flex-col">
        ...
        <div className="relative h-[480px] w-full overflow-hidden">
          <OptimizedImage
            src="/bird-control-hero.webp"
            fallbackSrc="/bird-control-hero.jpg"
            alt="Professional Bird Control and Management Services"
            fill
            priority
            sizes="100vw"
        ...
        <div className={`w-full bg-[#0a0a0a] px-6 py-10 -mt-10 rounded-t-3xl shadow-lg transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h1 className="text-3xl sm:text-4xl font-bold mb-5 leading-tight text-center">
            ...
            <span className="text-white block">BIRD CONTROL</span>
          </h1>

          <div className="w-24 h-1 bg-blue-500 mb-6 mx-auto"></div>

          <p className="text-lg mb-8 text-white text-center max-w-md mx-auto">
            Effective, humane solutions to protect your property from bird damage while respecting wildlife and environmental regulations.
          </p>

          <div className="flex justify-center gap-4 mt-2 mb-12">
            <Link href="/contact" className="modern-button bg-blue-500 hover:bg-blue-600 text-white transition-colors shadow-md">
              Schedule Inspection
            </Link>
      ...
      <div className="hidden md:block">
        ...
        <div className="absolute inset-0 z-[1] pointer-events-none">
          ...
          <div className="absolute bottom-1/4 left-1/3 w-2 h-2 rounded-full bg-blue-500/50 animate-pulse-slow delay-700"></div>
        </div>
