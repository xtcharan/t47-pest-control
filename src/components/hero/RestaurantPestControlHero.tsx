...
export default function RestaurantPestControlHero() {
    ...
    <div className="relative min-h-[600px] md:min-h-[650px] bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="md:hidden flex flex-col">
        ...
        <div className="relative h-[480px] w-full overflow-hidden">
          <OptimizedImage
            src="/restaurant-pest-control-hero.webp"
            fallbackSrc="/restaurant-pest-control-hero.jpg"
          ...
          <div className="absolute bottom-24 right-8 w-3 h-3 rounded-full bg-green-dark/60 animate-pulse-slow delay-300"></div>
        </div>
        ...
        <div className={`w-full bg-[#0a0a0a] px-6 py-10 -mt-10 rounded-t-3xl shadow-lg transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h1 className="text-3xl sm:text-4xl font-bold mb-5 leading-tight text-center">
            <span className="text-green-dark block mb-2">SPECIALIZED</span>
            <span className="text-white block">RESTAURANT PEST CONTROL</span>
          </h1>

          <div className="w-24 h-1 bg-green-light mb-6 mx-auto"></div>

          <p className="text-lg mb-8 text-white text-center max-w-md mx-auto">
            Comprehensive pest management solutions tailored for restaurants, cafes, and food service establishments.
          </p>
      ...
      <div className="hidden md:block">
        ...
        <div className="absolute inset-0 z-[1] pointer-events-none">
          ...
          <div className="absolute top-1/3 right-1/4 w-3 h-3 rounded-full bg-green-dark/40 animate-pulse-slow delay-300"></div>
          <div className="absolute bottom-1/4 left-1/3 w-2 h-2 rounded-full bg-green-light/50 animate-pulse-slow delay-700"></div>
        </div>
