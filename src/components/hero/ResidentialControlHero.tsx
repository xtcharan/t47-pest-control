...
export default function ResidentialControlHero() {
    ...
    <div className="relative min-h-[600px] md:min-h-[650px] bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="md:hidden flex flex-col">
        ...
        <div className="relative h-[480px] w-full overflow-hidden">
          <OptimizedImage
            src="/residential-pest-control.webp"
            fallbackSrc="/residential-pest-control.jpg"
        ...
        <div className={`w-full bg-[#0a0a0a] px-6 py-10 -mt-10 rounded-t-3xl shadow-lg transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h1 className="text-3xl sm:text-4xl font-bold mb-5 leading-tight text-center">
            <span className="text-green-light block mb-2">RESIDENTIAL</span>
          ...
          <p className="text-lg mb-8 text-white text-center max-w-md mx-auto">
            Protect your home and family with our comprehensive residential pest control solutions. Safe, effective, and guaranteed.
          </p>
          ...
          <div className="flex flex-col gap-4 mb-8">
            <Link
              href="#quote-form"
              className="bg-green-light hover:bg-green-dark text-white font-bold py-4 px-8 rounded-full text-center transition-colors text-lg shadow-lg"
            >
              Get Free Quote
            </Link>
            <Link
              href="#services"
              className="border-2 border-green-light text-green-light hover:bg-green-light hover:text-white font-bold py-4 px-8 rounded-full text-center transition-colors text-lg"
            >
              View Services
            </Link>
          </div>
          ...
          <div className="flex justify-center items-center gap-6 text-white text-sm">
            <div className="text-center">
              <div className="text-green-light font-bold text-lg">24/7</div>
              <div>Emergency Service</div>
            </div>
            <div className="text-center">
              <div className="text-green-light font-bold text-lg">100%</div>
              <div>Satisfaction</div>
            </div>
            <div className="text-center">
              <div className="text-green-light font-bold text-lg">Licensed</div>
      ...
      <div className="hidden md:flex h-full">
        ...
        <div className="w-1/2 flex items-center justify-center p-8 lg:p-12 bg-[#0a0a0a] relative z-10">
          <div className={`max-w-lg transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            <div className="w-24 h-1 bg-green-light mb-6"></div>

            <p className="text-xl text-white mb-8 leading-relaxed">
              Protect your home and family with our comprehensive residential pest control solutions. Safe, effective, and guaranteed results.
            </p>
            ...
            <div className="flex gap-8 text-white">
              <div>
                <div className="text-green-light font-bold text-xl">24/7</div>
                <div className="text-sm">Emergency Service</div>
              </div>
              <div>
                <div className="text-green-light font-bold text-xl">100%</div>
                <div className="text-sm">Satisfaction Guarantee</div>
              </div>
              <div>
                <div className="text-green-light font-bold text-xl">Licensed</div>
