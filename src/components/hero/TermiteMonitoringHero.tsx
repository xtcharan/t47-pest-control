...
export default function TermiteMonitoringHero() {
  ...
  return (
    <div className="relative min-h-[600px] md:min-h-[650px] bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <OptimizedImage
          src="/termite-monitoring-hero.jpg"
          fallbackSrc="/termite-inspection.jpg"
          alt="Professional Termite Monitoring Systems"
          fill
          priority
          sizes="100vw"
          ...
          <div className={`text-white space-y-6 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="space-y-4">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                Professional
                <span className="block text-blue-400">Termite Monitoring</span>
                <span className="block text-2xl md:text-3xl lg:text-4xl font-normal text-gray-300 mt-2">
                  24/7 Protection Systems
                </span>
              </h1>
              
              <p className="text-lg md:text-xl text-gray-300 max-w-xl leading-relaxed">
                Advanced termite monitoring systems providing continuous surveillance and early detection. 
                Protect your property with cutting-edge technology and professional expertise.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
              {[
                ...
                {
                  text: "Targeted Colony Elimination",
                  icon: (
                    <svg className="w-5 h-5 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
                ...
                {
                  text: "Expert Installation & Regular Servicing",
                  icon: (
                    <svg className="w-5 h-5 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
