    ...
    >
      ...
      <div className="md:hidden bg-blue-600 text-white py-1">
        <div className="container mx-auto px-2 flex justify-between items-center">
          ...
          <a href="tel:+61434300216" className="bg-white hover:bg-gray-100 text-blue-600 font-bold py-1.5 px-3 rounded text-xs transition-colors duration-300 flex items-center space-x-1">
            <svg
        ...
        <div className={`w-full ${showMobileMenu ? 'block' : 'hidden'} ${styles.mobileMenu}`}>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-gray-50 border-t border-gray-200 grid grid-cols-5 py-2 z-50">
            ...
            {/* Call Us */}
            <a href="tel:+61434300216" className="flex flex-col items-center justify-center text-gray-600 hover:text-red-600">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
