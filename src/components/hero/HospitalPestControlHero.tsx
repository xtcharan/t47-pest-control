...
export default function HospitalPestControlHero() {
    ...
    <div className="relative min-h-[600px] md:min-h-[650px] bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="md:hidden flex flex-col">
        ...
        <div className="relative h-[480px] w-full overflow-hidden">
          <OptimizedImage
            src="/hospital-pest-control-hero.webp"
            fallbackSrc="/hospital-pest-control-hero.jpg"
            alt="Hospital Pest Control Services"
            fill
            priority
            sizes="100vw"
          ...
          <div className="absolute top-6 left-0 right-0 flex justify-center">
            <span className="px-5 py-2 bg-blue-500/95 text-white text-sm font-bold rounded-full shadow-lg animate-float">
              HOSPITAL PEST CONTROL SERVICES
            </span>
          </div>

          {/* Small decorative elements */}
          <div className="absolute bottom-16 left-6 w-2 h-2 rounded-full bg-blue-400/70 animate-pulse-slow"></div>
          <div className="absolute bottom-24 right-8 w-3 h-3 rounded-full bg-blue-500/60 animate-pulse-slow delay-300"></div>
        </div>
        ...
        <div className={`w-full bg-[#0a0a0a] px-6 py-10 -mt-10 rounded-t-3xl shadow-lg transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h1 className="text-3xl sm:text-4xl font-bold mb-5 leading-tight text-center">
            <span className="text-blue-400 block mb-2">HEALTHCARE-GRADE</span>
            <span className="text-white block">HOSPITAL PEST CONTROL</span>
          </h1>

          <div className="w-24 h-1 bg-blue-500 mb-6 mx-auto"></div>

          <p className="text-lg mb-8 text-white text-center max-w-md mx-auto">
            Specialized pest management solutions for healthcare facilities that prioritize patient safety and regulatory compliance.
          </p>

          <div className="flex justify-center gap-4 mt-2 mb-12">
            <Link href="/contact" className="modern-button bg-blue-600 hover:bg-blue-700 text-white transition-colors shadow-md">
              Book Inspection
            </Link>
          ...
          {/* Quote form for mobile - with improved card-like styling */}
            <div className="w-full max-w-md mx-auto bg-[#111] p-6 rounded-xl shadow-lg border border-blue-500/20">
      ...
      <div className="hidden md:block">
        ...
        <div className="absolute inset-0 z-[1] pointer-events-none">
          <div className="absolute top-1/4 left-1/5 w-2 h-2 rounded-full bg-blue-400/50 animate-pulse-slow"></div>
          <div className="absolute top-1/3 right-1/4 w-3 h-3 rounded-full bg-blue-500/40 animate-pulse-slow delay-300"></div>
          <div className="absolute bottom-1/4 left-1/3 w-2 h-2 rounded-full bg-blue-600/50 animate-pulse-slow delay-700"></div>
        </div>
        ...
        <div className="container mx-auto px-4 py-16 md:py-20 relative z-10 flex flex-row items-center">
          ...
          >
            <div className="mb-6 inline-block">
              <span className="inline-block px-4 py-1 bg-blue-500/90 text-white text-sm font-bold rounded-full mb-4 animate-float">
                HOSPITAL PEST CONTROL SERVICES
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-4 mt-2">
              <Link href="/contact" className="modern-button bg-blue-600 hover:bg-blue-700 text-white transition-colors">
                Book Inspection
              </Link>
