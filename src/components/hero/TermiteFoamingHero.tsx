...
export default function TermiteFoamingHero() {
  ...
  return (
    <div className="relative min-h-[600px] md:min-h-[650px] bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <OptimizedImage
          src="/termite-foaming-hero.jpg"
          fallbackSrc="/termite-inspection.jpg"
          alt="Professional Termite Foaming Solutions"
          fill
          priority
          sizes="100vw"
          ...
          <div className={`text-white space-y-6 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="space-y-4">
              <span className="inline-block px-4 py-2 bg-blue-600/20 backdrop-blur-sm border border-blue-400/30 text-blue-300 text-sm font-semibold rounded-full">
                🧪 PRECISION FOAMING SOLUTIONS
              </span>
              
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                Termite Foaming Solutions
                <span className="block text-blue-400">for Homes & Businesses</span>
              ...
              <p className="text-lg md:text-xl text-gray-300 max-w-xl leading-relaxed">
                Advanced termite foaming solutions providing precision application and deep penetration. 
                Protect your property with cutting-edge foam technology and professional expertise.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
              {[
                {
                  text: "Precision Foam Application",
                  icon: (
                ...
                {
                  text: "Effective Termite Elimination",
                  icon: (
                    <svg className="w-5 h-5 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
                ...
                {
                  text: "Professional Application & Monitoring",
                  icon: (
                    <svg className="w-5 h-5 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
