...
export default function TermiteDustingProcedure() {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="relative rounded-xl overflow-hidden shadow-xl h-[400px] md:h-[500px] group">
              ...
              <div className="absolute inset-0.5 rounded-xl overflow-hidden z-20">
                ...
                <Image
                  src="/termite-dusting-process.jpg"
                  alt="Professional Termite Dusting Process"
                  fill
              ...
              <div className="absolute bottom-0 left-0 p-6 z-30">
                <h3 className="text-white font-bold text-xl mb-2">Precision Technology</h3>
                <p className="text-white/80 max-w-xs">Our dusting systems use precision application technology for accurate delivery and maximum effectiveness.</p>
              </div>
            </div>
          ...
          <div className="mt-12 text-center">
            <div className="bg-blue-600 text-white p-6 rounded-xl shadow-lg max-w-2xl mx-auto transform hover:scale-[1.02] transition-transform duration-300 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-xl font-semibold mb-3">Protect your property with targeted dusting treatment</h3>
                <p className="text-white/80 mb-4">Precise application is your best defense against termite colonies. Get our dusting treatment today.</p>
