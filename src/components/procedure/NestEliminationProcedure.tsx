...
export default function NestEliminationProcedure() {
  ...
  return (
    <>
      {/* Nest Elimination Process Section */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            <span className="inline-block px-3 py-1 bg-blue-100 text-blue-700 text-sm font-semibold rounded-full mb-3">
              COMPREHENSIVE ELIMINATION PROCESS
            </span>
            <h2 className="text-4xl font-bold mb-4 text-gray-900">
              Our Professional Termite <span className="text-blue-600">Nest Elimination</span> Process
            </h2>
            <div className="w-24 h-1 bg-blue-600 mx-auto mb-6"></div>
            <p className="text-gray-600 max-w-3xl mx-auto">
              Our comprehensive 5-step nest elimination process ensures complete removal for your property, 
              from nest location through complete destruction and ongoing prevention.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="relative rounded-xl overflow-hidden shadow-xl h-[400px] md:h-[500px] group">
              ...
              <div className="absolute inset-0.5 rounded-xl overflow-hidden z-20">
                ...
                <Image
                  src="/nest-elimination-process.jpg"
                  alt="Professional Termite Nest Elimination Process"
                  fill
              ...
              <div className="absolute bottom-0 left-0 p-6 z-30">
                <h3 className="text-white font-bold text-xl mb-2">Elimination Technology</h3>
                <p className="text-white/80 max-w-xs">Our elimination systems use advanced detection and removal technology for complete nest destruction and colony elimination.</p>
              </div>
            </div>
          ...
          <div className="mt-12 text-center">
            <div className="bg-blue-600 text-white p-6 rounded-xl shadow-lg max-w-2xl mx-auto transform hover:scale-[1.02] transition-transform duration-300 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-xl font-semibold mb-3">Protect your property with complete nest elimination</h3>
                <p className="text-white/80 mb-4">Complete removal is your best defense against termite colonies. Get our elimination service today.</p>
