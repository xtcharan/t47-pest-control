...
export default function SoilTreatmentProcedure() {
  ...
  return (
    <>
      {/* Soil Treatment Process Section */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="relative rounded-xl overflow-hidden shadow-xl h-[400px] md:h-[500px] group">
              ...
              <div className="absolute inset-0.5 rounded-xl overflow-hidden z-20">
                ...
                <Image
                  src="/soil-treatment-process.jpg"
                  alt="Professional Chemical Soil Treatment Process"
                  fill
              ...
              <div className="absolute bottom-0 left-0 p-6 z-30">
                <h3 className="text-white font-bold text-xl mb-2">Barrier Technology</h3>
                <p className="text-white/80 max-w-xs">Our soil treatment systems use advanced chemical barrier technology for comprehensive foundation protection.</p>
              </div>
            </div>
          ...
          <div className="mt-12 text-center">
            <div className="bg-blue-600 text-white p-6 rounded-xl shadow-lg max-w-2xl mx-auto transform hover:scale-[1.02] transition-transform duration-300 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-xl font-semibold mb-3">Protect your property with chemical soil barriers</h3>
                <p className="text-white/80 mb-4">Foundation protection is your best defense against termite intrusion. Get our soil treatment today.</p>
