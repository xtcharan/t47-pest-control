...
export default function TermiteBaitingProcedure() {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="relative rounded-xl overflow-hidden shadow-xl h-[400px] md:h-[500px] group">
              ...
              <div className="absolute inset-0.5 rounded-xl overflow-hidden z-20">
                ...
                <Image
                  src="/termite-baiting-process.jpg"
                  alt="Professional Termite Baiting Process"
                  fill
              ...
              <div className="absolute bottom-0 left-0 p-6 z-30">
                <h3 className="text-white font-bold text-xl mb-2">Strategic Technology</h3>
                <p className="text-white/80 max-w-xs">Our baiting systems use strategic placement technology for targeted colony elimination and ongoing protection.</p>
              </div>
            </div>
