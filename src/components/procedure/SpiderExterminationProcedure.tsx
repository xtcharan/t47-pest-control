...
export default function SpiderExterminationProcedure() {
  ...
  const procedureSteps = [
    {
      ...
      title: "Spider Infestation Inspection",
      description: "Our professional technicians begin by conducting a thorough inspection of your property to identify spider species, locate webs, egg sacs, and harborage areas. We pay special attention to dark, undisturbed areas like basements, attics, crawl spaces, and storage areas where spiders commonly hide."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      title: "Web Removal & Treatment",
      description: "We implement our treatment plan by first removing existing webs and egg sacs, then applying targeted treatments to spider harborage areas. Our approach includes crack and crevice treatments, perimeter applications, and spot treatments in areas where spiders are active. For venomous species like black widows or brown recluses, we use specialized techniques to ensure complete elimination."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "After successful elimination, we implement preventative measures to discourage spiders from returning. This includes sealing entry points, removing attractants like other insects that serve as food sources, reducing clutter, and applying residual treatments to create a protective barrier. We also provide recommendations for ongoing prevention to keep your property spider-free."
    }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl font-bold mb-4 text-gray-900">
            Our Spider <span className="text-blue-600">Extermination</span> Procedure
          </h2>
          <div className="w-24 h-1 bg-blue-600 mx-auto mb-6"></div>
          <p className="text-gray-600 max-w-3xl mx-auto">
            Our comprehensive approach to spider control targets both active spiders and their egg sacs, ensuring complete elimination and long-term protection for your property.
          </p>
        </div>
          ...
          <div className="relative rounded-xl overflow-hidden shadow-xl h-[400px] md:h-[500px] group">
            ...
            <div className="absolute inset-0.5 rounded-xl overflow-hidden z-20">
              ...
              <OptimizedImage
                ...
                fallbackSrc="/extermination.jpg"
                alt="Spider Extermination Procedure"
                fill
        ...
        <div className="mt-12 text-center">
          <div className="bg-blue-600 text-white p-6 rounded-xl shadow-lg max-w-2xl mx-auto transform hover:scale-[1.02] transition-transform duration-300 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-xl font-semibold mb-3">Ready to eliminate your spider problem?</h3>
              <p className="text-white/80 mb-4">Our professional spider control team is ready to help you get rid of spiders for good.</p>
