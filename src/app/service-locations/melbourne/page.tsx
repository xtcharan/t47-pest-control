...
export default function MelbourneServicePage() {
  const serviceAreas = [
    'Melbourne CBD', 'South Yarra', 'Richmond', 'Fitzroy', 'St Kilda',
    'Dandenong', 'Frankston', 'Werribee', 'Geelong', 'Mornington Peninsula'
  ];

  const services = [
    {
      name: 'Termite Inspection & Treatment',
      description: 'Advanced termite detection and elimination for Melbourne properties.',
      icon: '🐛'
    },
    {
      name: 'General Pest Control',
      description: 'Comprehensive treatment for Melbourne\'s common household pests.',
      icon: '🕷️'
    },
    {
      name: 'Commercial Pest Management',
      description: 'Professional solutions for Melbourne businesses and hospitality.',
      icon: '🏢'
    },
    {
      name: 'Emergency Pest Control',
      description: 'Same-day response for urgent pest situations across Melbourne.',
      icon: '🚨'
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Pest Control
              <span className="block text-green-light mt-2">Melbourne</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
              Expert pest control services across Melbourne, Dandenong, Frankston, Werribee, 
              and Geelong. Professional solutions for Victoria's unique pest challenges.
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-8 text-center">
              Melbourne Pest Control Expertise
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                <h3 className="text-xl font-bold text-primary mb-4">Common Melbourne Pests</h3>
                <ul className="space-y-2 text-gray-700">
                  <li>• Subterranean Termites</li>
                  <li>• German Cockroaches</li>
                  <li>• Redback Spiders</li>
                  <li>• Black House Ants</li>
                  <li>• European Wasps</li>
                  <li>• Norway Rats</li>
                </ul>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                <h3 className="text-xl font-bold text-primary mb-4">Why Choose T47 Melbourne</h3>
                <ul className="space-y-2 text-gray-700">
                  <li>• Local Melbourne technicians</li>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Need Pest Control in Melbourne?
            </h2>
            <p className="text-xl mb-8">
              Contact our Melbourne team for immediate assistance and professional pest control solutions.
            </p>
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white/10 p-6 rounded-lg">
                <h3 className="text-lg font-bold mb-2">📞 Call Melbourne</h3>
